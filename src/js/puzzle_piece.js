var PuzzlePiece = function(game, x, y, j, i, width, height, pic, sides) {
  ...
  if (this.left_side === 0) {
    ...
    this.piecebmd.ctx.lineTo(Math.floor(tl.x+width*0.13),Math.floor(tl.y+height/3));
    this.piecebmd.ctx.lineTo(Math.floor(tl.x+width*0.15),Math.floor(tl.y+height/3+height/6));
    this.piecebmd.ctx.lineTo(Math.floor(tl.x+width*0.13),Math.floor(tl.y+height/3+2*height/6));
  ...
  if (this.right_side === 0) {
    ...
    this.piecebmd.ctx.lineTo(Math.floor(br.x-width*0.13),Math.floor(br.y-height/3));
    this.piecebmd.ctx.lineTo(Math.floor(br.x-width*0.15),Math.floor(br.y-height/3-height/6));
    this.piecebmd.ctx.lineTo(Math.floor(br.x-width*0.13),Math.floor(br.y-height/3-2*height/6));
  ...
  area = new Phaser.Rectangle(
      j*width-(Math.abs(padX- width*0.10)),
      i*height-(Math.abs(padY - height*0.10)),
      w,
      h
  );
